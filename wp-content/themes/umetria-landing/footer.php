...
<footer class="footer">
	<div class="container">
		<div class="footer__inner">
			...
			<a href="" target="_blank">Конфиденциальность</a> и <a href="" target="_blank">Условия использования</a>.</div>
			<div class="footer__copyright">© 2024, Цифровая стоматология «Umetria». Все права защищены</div>
		</div>
	</div>
</footer>
